...
inline const std::unordered_map<ResponseStatusCode, std::string> kStatusCodeStrings = {
    ...
    {ResponseStatusCode::kMultipleChoices, "300 Multiple Choices"},
    {ResponseStatusCode::kMovedPermanently, "301 Moved Permanently"},
    {ResponseStatusCode::kFound, "302 Found"},
    {ResponseStatusCode::kSeeOther, "303 See Other"},
    {ResponseStatusCode::kNotModified, "304 Not Modified"},
    {ResponseStatusCode::kUseProxy, "305 Use Proxy"},
    {ResponseStatusCode::kSwitchProxy, "306 Switch Proxy"},
    {ResponseStatusCode::kTemporaryRedirect, "307 Temporary Redirect"},
    {ResponseStatusCode::kPermanentRedirect, "308 Permanent Redirect"},
